...
/* harmony import */ var _views_SystemTagsSection_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/SystemTagsSection.vue */ "./apps/systemtags/src/views/SystemTagsSection.vue");
/**
...
const SystemTagsSectionView = vue__WEBPACK_IMPORTED_MODULE_1__["default"].extend(_views_SystemTagsSection_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
/* harmony import */ var _nextcloud_vue_components_NcSelectTags__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nextcloud/vue/components/NcSelectTags */ "./node_modules/@nextcloud/vue/dist/Components/NcSelectTags.mjs");
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils.js */ "./apps/systemtags/src/utils.ts");
/* harmony import */ var _services_api_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/api.js */ "./apps/systemtags/src/services/api.ts");
/* eslint-disable */
...
const tagLevelOptions = [{
  id: TagLevel.Public,
  label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Public')
}, {
  id: TagLevel.Restricted,
  label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Restricted')
}, {
  id: TagLevel.Invisible,
  label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Invisible')
}];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend({
  ...
  components: {
    ...
    NcSelectTags: _nextcloud_vue_components_NcSelectTags__WEBPACK_IMPORTED_MODULE_4__["default"],
  ...
  methods: {
    ...
    async create() {
      const tag = {
        ..._utils_js__WEBPACK_IMPORTED_MODULE_8__.defaultBaseTag,
        ...this.tagProperties
      };
      this.loading = true;
      try {
        const id = await (0,_services_api_js__WEBPACK_IMPORTED_MODULE_9__.createTag)(tag);
        const createdTag = {
          ...tag,
          id
        };
        this.$emit('tag:created', createdTag);
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_7__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Created tag'));
        this.reset();
      } catch (error) {
        this.errorMessage = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Failed to create tag');
      }
      this.loading = false;
    },
    async update() {
      ...
      this.loading = true;
      try {
        await (0,_services_api_js__WEBPACK_IMPORTED_MODULE_9__.updateTag)(tag);
        this.selectedTag = tag;
        this.$emit('tag:updated', tag);
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_7__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Updated tag'));
        this.$refs.tagNameInput?.focus();
      } catch (error) {
        this.errorMessage = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Failed to update tag');
      }
      this.loading = false;
    },
    async handleDelete() {
      ...
      this.loading = true;
      try {
        await (0,_services_api_js__WEBPACK_IMPORTED_MODULE_9__.deleteTag)(this.selectedTag);
        this.$emit('tag:deleted', this.selectedTag);
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_7__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Deleted tag'));
        this.reset();
      } catch (error) {
        this.errorMessage = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)('systemtags', 'Failed to delete tag');
      }
      this.loading = false;
    },
    reset() {
...
/* harmony import */ var _components_SystemTagForm_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/SystemTagForm.vue */ "./apps/systemtags/src/components/SystemTagForm.vue");
/* harmony import */ var _components_SystemTagsCreationControl_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/SystemTagsCreationControl.vue */ "./apps/systemtags/src/components/SystemTagsCreationControl.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend({
  ...
  components: {
    ...
    SystemTagForm: _components_SystemTagForm_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    SystemTagsCreationControl: _components_SystemTagsCreationControl_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  data() {
    return {
      loadingTags: false,
  ...
  async created() {
    ...
    try {
      this.tags = await (0,_services_api_js__WEBPACK_IMPORTED_MODULE_7__.fetchTags)();
    } catch (error) {
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_4__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.translate)('systemtags', 'Failed to load tags'));
    }
...
/******/ })()
;
//# sourceMappingURL=systemtags-admin.js.map?v=8984497856b4f486a73d