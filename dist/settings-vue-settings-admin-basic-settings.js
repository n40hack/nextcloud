...
const ACCOUNT_PROPERTY_READABLE_ENUM = Object.freeze({
  ADDRESS: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Location'),
  AVATAR: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Profile picture'),
  BIOGRAPHY: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'About'),
  BIRTHDATE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Date of birth'),
  DISPLAYNAME: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Full name'),
  EMAIL_COLLECTION: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Additional email'),
  EMAIL: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Email'),
  FEDIVERSE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Fediverse (e.g. Mastodon)'),
  HEADLINE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Headline'),
  ORGANISATION: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Organisation'),
  PHONE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Phone number'),
  PROFILE_ENABLED: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Profile'),
  PRONOUNS: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Pronouns'),
  ROLE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Role'),
  TWITTER: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'X (formerly Twitter)'),
  BLUESKY: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Bluesky'),
  WEBSITE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Website')
});
...
const PROFILE_READABLE_ENUM = Object.freeze({
  PROFILE_VISIBILITY: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Profile visibility')
});
...
const ACCOUNT_SETTING_PROPERTY_READABLE_ENUM = Object.freeze({
  LANGUAGE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Language'),
  LOCALE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Locale'),
  FIRST_DAY_OF_WEEK: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'First day of week'),
  TIMEZONE: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'timezone')
});
/** Enum of scopes */
var SCOPE_ENUM;
(function (SCOPE_ENUM) {
...
const SCOPE_PROPERTY_ENUM = Object.freeze({
  [SCOPE_ENUM.PRIVATE]: {
    ...
    displayName: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Private'),
    tooltip: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Only visible to people matched via phone number integration through Talk on mobile'),
    tooltipDisabled: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Not available as this property is required for core functionality including file sharing and calendar invitations'),
    icon: _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiCellphone
  },
  [SCOPE_ENUM.LOCAL]: {
    name: SCOPE_ENUM.LOCAL,
    displayName: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Local'),
    tooltip: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Only visible to people on this instance and guests'),
    // tooltipDisabled is not required here as this scope is supported by all account properties
    icon: _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiLockOutline
  },
  [SCOPE_ENUM.FEDERATED]: {
    name: SCOPE_ENUM.FEDERATED,
    displayName: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Federated'),
    tooltip: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Only synchronize to trusted servers'),
    tooltipDisabled: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Not available as federation has been disabled for your account, contact your system administration if you have any questions'),
    icon: _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiAccountGroupOutline
  },
  [SCOPE_ENUM.PUBLISHED]: {
    name: SCOPE_ENUM.PUBLISHED,
    displayName: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Published'),
    tooltip: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Synchronize to trusted servers and the global and public address book'),
    tooltipDisabled: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'Not available as publishing account specific data to the lookup server is not allowed, contact your system administration if you have any questions'),
    icon: _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiWeb
  }
});
...
const profileEnabledGlobally = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'profileEnabledGlobally', true);
vue__WEBPACK_IMPORTED_MODULE_0__["default"].mixin({
  props: {
    logger: _logger_ts__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  methods: {
    t: _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.translate
  }
});
const BackgroundJobView = vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_components_BasicSettings_BackgroundJob_vue__WEBPACK_IMPORTED_MODULE_6__["default"]);
new BackgroundJobView().$mount('#vue-admin-background-job');
if (profileEnabledGlobally) {
  const ProfileSettingsView = vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_components_BasicSettings_ProfileSettings_vue__WEBPACK_IMPORTED_MODULE_5__["default"]);
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-basic-settings.js.map?v=2668252d87419ebaca60