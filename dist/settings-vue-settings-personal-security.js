...
/* harmony import */ var _nextcloud_password_confirmation_dist_style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @nextcloud/password-confirmation/dist/style.css */ "./node_modules/@nextcloud/password-confirmation/dist/style.css");
/**
...
const useAuthTokenStore = (0,pinia__WEBPACK_IMPORTED_MODULE_5__.defineStore)('auth-token', {
  state() {
    return {
  ...
  actions: {
    ...
    async updateToken(token) {
      const {
        data
      } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_6__["default"].put(`${BASE_URL}/${token.id}`, token);
      return data;
    },
    /**
     * Add a new token
     ...
     */
    async addToken(name) {
      _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('Creating a new app token');
      try {
        await (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_3__.confirmPassword)();
        const {
          data
        } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_6__["default"].post(BASE_URL, {
          name
        });
        this.tokens.push(data.deviceToken);
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('App token created');
        return data;
      } catch (error) {
        return null;
      }
    ...
    async deleteToken(token) {
      _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('Deleting app token', {
        token
      });
      ...
      try {
        await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_6__["default"].delete(`${BASE_URL}/${token.id}`);
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('App token deleted');
        return true;
      } catch (error) {
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].error('Could not delete app token', {
          error
        });
    ...
    async wipeToken(token) {
      _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('Wiping app token', {
        token
      });
      try {
        await (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_3__.confirmPassword)();
        if (!(await confirm())) {
          _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('Wipe aborted by user');
          return;
        }
        await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_6__["default"].post(`${BASE_URL}/wipe/${token.id}`);
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('App token marked for wipe', {
          token
        });
        ...
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].error('Could not wipe app token', {
          error
        });
    ...
    async renameToken(token, newName) {
      _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug(`renaming app token ${token.id} from ${token.name} to '${newName}'`);
      const oldName = token.name;
      token.name = newName;
      try {
        await this.updateToken(token);
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('App token name updated');
        return true;
      } catch (error) {
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].error('Could not update app token name', {
          error
        });
    ...
    async setTokenScope(token, scope, value) {
      _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('Updating app token scope', {
        token,
        scope,
        value
      });
      ...
      try {
        await this.updateToken(token);
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].debug('app token scope updated');
        return true;
      } catch (error) {
        _logger__WEBPACK_IMPORTED_MODULE_7__["default"].error('could not update app token scope', {
          error
        });
...
/* harmony import */ var _nextcloud_vue_components_NcActionCheckbox__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/vue/components/NcActionCheckbox */ "./node_modules/@nextcloud/vue/dist/Components/NcActionCheckbox.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_2__.defineComponent)({
  ...
  components: {
    ...
    NcActionCheckbox: _nextcloud_vue_components_NcActionCheckbox__WEBPACK_IMPORTED_MODULE_6__["default"],
    NcButton: _nextcloud_vue_components_NcButton__WEBPACK_IMPORTED_MODULE_7__["default"],
    NcDateTime: _nextcloud_vue_components_NcDateTime__WEBPACK_IMPORTED_MODULE_8__["default"],
  ...
  computed: {
    canChangeScope() {
      return this.token.type === _store_authtoken_ts__WEBPACK_IMPORTED_MODULE_3__.TokenType.PERMANENT_TOKEN;
    },
    /**
    ...
    tokenIcon() {
      ...
      if (this.token.type === _store_authtoken_ts__WEBPACK_IMPORTED_MODULE_3__.TokenType.PERMANENT_TOKEN) {
     ...
     */
    wiping() {
      return this.token.type === _store_authtoken_ts__WEBPACK_IMPORTED_MODULE_3__.TokenType.WIPING_TOKEN;
    }
  },
  methods: {
...
/* harmony import */ var _AuthToken_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AuthToken.vue */ "./apps/settings/src/components/AuthToken.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_1__.defineComponent)({
  name: 'AuthTokenList',
  components: {
    AuthToken: _AuthToken_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  setup() {
...
/* harmony import */ var _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/l10n */ "./node_modules/@nextcloud/l10n/dist/index.mjs");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _store_authtoken__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../store/authtoken */ "./apps/settings/src/store/authtoken.ts");
...
/* harmony import */ var _AuthTokenSetupDialog_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./AuthTokenSetupDialog.vue */ "./apps/settings/src/components/AuthTokenSetupDialog.vue");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../logger */ "./apps/settings/src/logger.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_2__.defineComponent)({
  ...
  components: {
    ...
    AuthTokenSetupDialog: _AuthTokenSetupDialog_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  setup() {
    const authTokenStore = (0,_store_authtoken__WEBPACK_IMPORTED_MODULE_3__.useAuthTokenStore)();
    return {
      authTokenStore
    };
  },
...
/* harmony import */ var _chenfengyuan_vue_qrcode__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @chenfengyuan/vue-qrcode */ "./node_modules/@chenfengyuan/vue-qrcode/dist/vue-qrcode.js");
/* harmony import */ var _chenfengyuan_vue_qrcode__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_chenfengyuan_vue_qrcode__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../logger */ "./apps/settings/src/logger.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_4__.defineComponent)({
  ...
  components: {
    ...
    QR: (_chenfengyuan_vue_qrcode__WEBPACK_IMPORTED_MODULE_5___default())
  },
  props: {
    token: {
      type: Object,
  ...
  computed: {
    ...
    copyPasswordIcon() {
      return this.isPasswordCopied ? _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiCheck : _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiContentCopy;
    },
    copyNameIcon() {
      return this.isNameCopied ? _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiCheck : _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiContentCopy;
    },
    appPassword() {
    ...
    qrUrl() {
      const server = window.location.protocol + '//' + window.location.host + (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.getRootUrl)();
      return `nc://login/user:${this.loginName}&password:${this.appPassword}&server:${server}`;
    },
    copyPasswordLabel() {
      if (this.isPasswordCopied) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('settings', 'App password copied!');
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('settings', 'Copy app password');
    },
    copyLoginNameLabel() {
      if (this.isNameCopied) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('settings', 'Login name copied!');
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('settings', 'Copy login name');
    }
  },
  watch: {
    token() {
  ...
  methods: {
    ...
    async copyPassword() {
      try {
        ...
        _logger__WEBPACK_IMPORTED_MODULE_10__["default"].error(e);
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('settings', 'Could not copy app password. Please copy it manually.'));
      } finally {
        setTimeout(() => {
          this.isPasswordCopied = false;
        }, 4000);
    ...
    async copyLoginName() {
      try {
        ...
        _logger__WEBPACK_IMPORTED_MODULE_10__["default"].error(e);
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('settings', 'Could not copy login name. Please copy it manually.'));
      } finally {
        setTimeout(() => {
          this.isNameCopied = false;
        }, 4000);
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-personal-security.js.map?v=427fc8cd5a65ddedee32