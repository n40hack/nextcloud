...
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _nextcloud_vue_components_NcTextField__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/vue/components/NcTextField */ "./node_modules/@nextcloud/vue/dist/Components/NcTextField.mjs");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  name: 'TemplateRichTextField',
  components: {
    NcTextField: _nextcloud_vue_components_NcTextField__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  props: {
    field: {
      type: Object,
...
/* harmony import */ var _nextcloud_files_dav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nextcloud/files/dav */ "./node_modules/@nextcloud/files/dist/dav.mjs");
...
/* harmony import */ var _services_Templates_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/Templates.js */ "./apps/files/src/services/Templates.js");
/* harmony import */ var _nextcloud_vue_components_NcEmptyContent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @nextcloud/vue/components/NcEmptyContent */ "./node_modules/@nextcloud/vue/dist/Components/NcEmptyContent.mjs");
/* harmony import */ var _nextcloud_vue_components_NcModal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @nextcloud/vue/components/NcModal */ "./node_modules/@nextcloud/vue/dist/Components/NcModal.mjs");
/* harmony import */ var _components_TemplatePreview_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/TemplatePreview.vue */ "./apps/files/src/components/TemplatePreview.vue");
/* harmony import */ var _components_TemplateFiller_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/TemplateFiller.vue */ "./apps/files/src/components/TemplateFiller.vue");
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../logger.ts */ "./apps/files/src/logger.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_8__.defineComponent)({
  name: 'TemplatePicker',
  components: {
    NcEmptyContent: _nextcloud_vue_components_NcEmptyContent__WEBPACK_IMPORTED_MODULE_10__["default"],
    NcModal: _nextcloud_vue_components_NcModal__WEBPACK_IMPORTED_MODULE_11__["default"],
    TemplatePreview: _components_TemplatePreview_vue__WEBPACK_IMPORTED_MODULE_12__["default"]
  },
  props: {
    /**
  ...
  computed: {
    extension() {
      return (0,path__WEBPACK_IMPORTED_MODULE_7__.extname)(this.name ?? '');
    },
    nameWithoutExt() {
    ...
    emptyTemplate() {
      return {
        basename: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Blank'),
        fileid: -1,
        filename: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Blank'),
        hasPreview: false,
  ...
  methods: {
    ...
    async open(name, provider) {
      ...
      const templates = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_9__.getTemplates)();
    ...
    async createFile() {
      ...
      if (this.nameWithoutExt === this.name) {
        _logger_ts__WEBPACK_IMPORTED_MODULE_14__["default"].warn('Fixed invalid filename', {
          name: this.name,
      ...
      if ((0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)() === null) {
        const client = (0,_nextcloud_files_dav__WEBPACK_IMPORTED_MODULE_4__.getClient)();
        const filename = (0,path__WEBPACK_IMPORTED_MODULE_7__.join)((0,_nextcloud_files_dav__WEBPACK_IMPORTED_MODULE_4__.getRootPath)(), currentDirectory, this.name ?? '');
        await client.putFileContents(filename, '');
        const response = await client.stat(filename, {
          data: (0,_nextcloud_files_dav__WEBPACK_IMPORTED_MODULE_4__.getDefaultPropfind)(),
          details: true
        });
        _logger_ts__WEBPACK_IMPORTED_MODULE_14__["default"].debug('Created new file', {
          fileInfo: response.data
        });
        const node = (0,_nextcloud_files_dav__WEBPACK_IMPORTED_MODULE_4__.resultToNode)(response.data);
        this.handleFileCreation(node);
      } else {
        try {
          const fileInfo = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_9__.createFromTemplate)((0,path__WEBPACK_IMPORTED_MODULE_7__.normalize)(`${currentDirectory}/${this.name}`), this.selectedTemplate?.filename ?? '', this.selectedTemplate?.templateType ?? '', templateFields);
          _logger_ts__WEBPACK_IMPORTED_MODULE_14__["default"].debug('Created new file', {
            fileInfo
          });
          ...
          const node = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_3__.File({
            id: fileInfo.fileid,
            source: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_6__.generateRemoteUrl)((0,path__WEBPACK_IMPORTED_MODULE_7__.join)(`dav/files/${owner}`, fileInfo.filename)),
            root: `/files/${owner}`,
            mime: fileInfo.mime,
          ...
          _logger_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('Error while creating the new file from template', {
            error
          });
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.translate)('files', 'Unable to create new file from template'));
        } finally {
          this.loading = false;
        }
      }
    },
    handleFileCreation(node) {
      // Update files list
    ...
    async onSubmit() {
      ...
      if (fileId && fileId !== this.emptyTemplate.fileid) {
        fields = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_9__.getTemplateFields)(fileId);
      }
      if (fields.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.spawnDialog)(_components_TemplateFiller_vue__WEBPACK_IMPORTED_MODULE_13__["default"], {
          fields,
...
/* harmony import */ var _nextcloud_vue_components_NcModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nextcloud/vue/components/NcModal */ "./node_modules/@nextcloud/vue/dist/Components/NcModal.mjs");
/* harmony import */ var _TemplateFiller_TemplateRichTextField_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TemplateFiller/TemplateRichTextField.vue */ "./apps/files/src/components/TemplateFiller/TemplateRichTextField.vue");
/* harmony import */ var _TemplateFiller_TemplateCheckboxField_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TemplateFiller/TemplateCheckboxField.vue */ "./apps/files/src/components/TemplateFiller/TemplateCheckboxField.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  name: 'TemplateFiller',
  components: {
    NcModal: _nextcloud_vue_components_NcModal__WEBPACK_IMPORTED_MODULE_4__["default"],
    ...
    TemplateRichTextField: _TemplateFiller_TemplateRichTextField_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    TemplateCheckboxField: _TemplateFiller_TemplateCheckboxField_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  props: {
    fields: {
      type: Array,
...
//# sourceMappingURL=apps_files_src_views_TemplatePicker_vue-apps_files_src_views_TemplatePicker_vue.js.map?v=8b2cbaa802b320b858ad