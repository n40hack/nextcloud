...
MountConfigListView.prototype = _.extend({
  ...
  deleteStorageConfig($tr) {
    ...
    OC.dialogs.confirm((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.t)('files_external', 'Are you sure you want to disconnect this external storage?') + ' ' + (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.t)('files_external', 'It will make the storage unavailable in {instanceName} and will lead to a deletion of these files and folders on any sync client that is currently connected but will not delete any files and folders on the external storage itself.', {
...
/******/ })()
;
//# sourceMappingURL=files_external-settings.js.map?v=2985d0b124da7b56df3a