...
/* harmony import */ var _components_AdminAI_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/AdminAI.vue */ "./apps/settings/src/components/AdminAI.vue");
/**
...
const View = vue__WEBPACK_IMPORTED_MODULE_1__["default"].extend(_components_AdminAI_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
/* harmony import */ var _nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @nextcloud/initial-state */ "./node_modules/@nextcloud/initial-state/dist/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    async saveChanges() {
      this.loading = true;
      await (0,vue__WEBPACK_IMPORTED_MODULE_11__.nextTick)();
      const data = {
        settings: this.settings
      };
      try {
        await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].put((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_12__.generateUrl)('/settings/api/admin/ai'), data);
      } catch (err) {
...
var render = function render() {
  ...
  }, [_vm._v("\n\t\t\t" + _vm._s(_vm.t("settings", "Allow AI usage for guest users")) + "\n\t\t")]), _vm._v(" "), _c("h3", [_vm._v(_vm._s(_vm.t("settings", "Provider for Task types")))]), _vm._v(" "), _vm._l(_vm.taskProcessingTaskTypes, function (type) {
    return [_c("div", {
      key: type,
      staticClass: "tasktype-item"
    }, [_c("p", {
      staticClass: "tasktype-name"
...
.tasktype-item[data-v-0e831806] {
  display: flex;
  align-items: center;
  gap: 8px;
.tasktype-name[data-v-0e831806] {
    flex: 1;
    margin: 0;
}
}
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-ai.js.map?v=5cb9830dc6b1fce1764a