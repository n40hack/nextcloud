"use strict";
(self["webpackChunknextcloud"] = self["webpackChunknextcloud"] || []).push([["node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-B_BCSatD_mjs"],{
...
/***/ "./node_modules/@nextcloud/upload/dist/chunks/InvalidFilenameDialog-B_BCSatD.mjs":
/*!***************************************************************************************!*\
  !*** ./node_modules/@nextcloud/upload/dist/chunks/InvalidFilenameDialog-B_BCSatD.mjs ***!
  \***************************************************************************************/
...
const _sfc_main = (0,vue__WEBPACK_IMPORTED_MODULE_2__.defineComponent)({
  ...
  computed: {
    ...
    dialogButtons() {
      const buttons = [
        {
          label: (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("Cancel"),
          type: "error",
          callback: () => {
        ...
        {
          label: (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("Skip"),
          callback: () => {
      ...
      if (this.canRename) {
        buttons.push({
          label: (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("Rename"),
          type: "primary",
    ...
    getErrorText(error) {
      switch (error.reason) {
        case _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.InvalidFilenameErrorReason.Character:
          return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)('"{segment}" is not allowed inside a file or folder name.', { segment: error.segment });
        case _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.InvalidFilenameErrorReason.ReservedName:
          return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)('"{segment}" is a forbidden file or folder name.', { segment: error.segment });
        case _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.InvalidFilenameErrorReason.Extension:
          return error.segment.match(/\.\w/) ? (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)('"{segment}" is a forbidden file type.', { segment: error.segment }) : (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)('Filenames must not end with "{segment}".', { segment: error.segment });
      }
    }
  }
});
...
//# sourceMappingURL=node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-B_BCSatD_mjs-node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-B_BCSatD_mjs.js.map?v=59d127696747fece8ee8