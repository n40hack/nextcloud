...
/* harmony import */ var _services_logger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/logger */ "./apps/files_sharing/src/services/logger.ts");
...
const registerFileRequestHeader = nickname => {
  ...
  _services_logger__WEBPACK_IMPORTED_MODULE_6__["default"].debug('Nickname header registered for uploader', {
    headers: uploader.customHeaders
  });
};
// Callback when a nickname was chosen
const onUserInfoChanged = guest => {
  _services_logger__WEBPACK_IMPORTED_MODULE_6__["default"].debug('User info changed', {
    guest
  });
  registerFileRequestHeader(guest.displayName ?? '');
};
// Monitor nickname changes
(0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_7__.subscribe)('user:info:changed', onUserInfoChanged);
window.addEventListener('DOMContentLoaded', () => {
  ...
  const isFileRequest = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('files_sharing', 'isFileRequest', false);
  const owner = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('files_sharing', 'owner', '');
  const ownerDisplayName = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('files_sharing', 'ownerDisplayName', '');
  const label = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('files_sharing', 'label', '');
  const filename = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('files_sharing', 'filename', '');
  // If the owner provided a custom label, use it instead of the filename
  const folder = label || filename;
  const options = {
    nickname,
    notice: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.t)('files_sharing', 'To upload files to {folder}, you need to provide your name first.', {
      folder
    }),
    subtitle: undefined,
    title: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.t)('files_sharing', 'Upload files to {folder}', {
      folder
    })
  };
  // If the guest already has a nickname, we just make them double check
  if (nickname) {
    options.notice = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.t)('files_sharing', 'Please confirm your name to upload files to {folder}', {
      folder
    });
  }
  ...
  if (owner) {
    options.subtitle = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.t)('files_sharing', '{ownerDisplayName} shared a folder with you.', {
      ownerDisplayName
    });
  }
  ...
  if (isFileRequest) {
    ...
    if (!nickname || !dialogShown) {
      _services_logger__WEBPACK_IMPORTED_MODULE_6__["default"].debug('Showing public auth prompt.', {
        nickname
      });
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_4__.showGuestUserPrompt)(options);
    }
    return;
  }
  if (!dialogShown && !nickname) {
    _services_logger__WEBPACK_IMPORTED_MODULE_6__["default"].debug('Public auth prompt not shown yet but nickname is not mandatory.', {
      nickname
    });
    return;
  }
  // Else, we just register the nickname header if any.
  _services_logger__WEBPACK_IMPORTED_MODULE_6__["default"].debug('Public auth prompt already shown.', {
    nickname
  });
...
/******/ 		var installedChunks = {
/******/ 			"files_sharing-public-nickname-handler": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["core-common"], () => (__webpack_require__("./apps/files_sharing/src/public-nickname-handler.ts")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=files_sharing-public-nickname-handler.js.map?v=7109d96e2f51d959b72f