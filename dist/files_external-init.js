...
/* harmony import */ var _utils_credentialsUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/credentialsUtils */ "./apps/files_external/src/utils/credentialsUtils.ts");
/* harmony import */ var _utils_externalStorageUtils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/externalStorageUtils */ "./apps/files_external/src/utils/externalStorageUtils.ts");
...
async function setCredentials(node, login, password) {
  ...
  if (config.status !== _utils_credentialsUtils__WEBPACK_IMPORTED_MODULE_8__.STORAGE_STATUS.SUCCESS) {
  ...
  vue__WEBPACK_IMPORTED_MODULE_6__["default"].set(node.attributes, 'config', config);
  return true;
}
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_7__.FileAction({
  ...
  enabled: nodes => {
    ...
    const node = nodes[0];
    if (!(0,_utils_externalStorageUtils__WEBPACK_IMPORTED_MODULE_9__.isNodeExternalStorage)(node)) {
      return false;
    }
    const config = node.attributes?.config || {};
    if ((0,_utils_credentialsUtils__WEBPACK_IMPORTED_MODULE_8__.isMissingAuthConfig)(config)) {
      return true;
    }
    return false;
  },
  async exec(node) {
    const {
      login,
      password
    } = await new Promise(resolve => (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__.spawnDialog)((0,vue__WEBPACK_IMPORTED_MODULE_6__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_files_external_src_views_CredentialsDialog_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ../views/CredentialsDialog.vue */ "./apps/files_external/src/views/CredentialsDialog.vue"))), {}, args => {
      resolve(args);
    }));
    if (login && password) {
      try {
  ...
  order: -1000,
  default: _nextcloud_files__WEBPACK_IMPORTED_MODULE_7__.DefaultType.DEFAULT,
  inline: () => true
});
...
/* harmony import */ var _css_fileEntryStatus_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../css/fileEntryStatus.scss */ "./apps/files_external/src/css/fileEntryStatus.scss");
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  iconSvgInline: () => '',
  enabled: nodes => {
    return nodes.every(node => (0,_utils_externalStorageUtils__WEBPACK_IMPORTED_MODULE_8__.isNodeExternalStorage)(node) === true);
  },
  exec: async () => null,
  /**
  ...
  async renderInline(node) {
    ...
    let config = null;
    (0,_services_externalStorage__WEBPACK_IMPORTED_MODULE_6__.getStatus)(node.attributes.id, node.attributes.scope === 'system').then(response => {
      config = response.data;
      vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(node.attributes, 'config', config);
      ...
      const isWarning = !config ? false : (0,_utils_credentialsUtils__WEBPACK_IMPORTED_MODULE_7__.isMissingAuthConfig)(config);
...
/* harmony import */ var _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/l10n */ "./node_modules/@nextcloud/l10n/dist/index.mjs");
/* harmony import */ var _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @nextcloud/files */ "./node_modules/@nextcloud/files/dist/index.mjs");
/* harmony import */ var _mdi_svg_svg_folder_network_outline_svg_raw__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mdi/svg/svg/folder-network-outline.svg?raw */ "./node_modules/@mdi/svg/svg/folder-network-outline.svg?raw");
...
Navigation.register(new _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.View({
  ...
  icon: _mdi_svg_svg_folder_network_outline_svg_raw__WEBPACK_IMPORTED_MODULE_3__,
  order: 30,
...
/***/ "./node_modules/@mdi/svg/svg/folder-network-outline.svg?raw":
/*!******************************************************************!*\
  !*** ./node_modules/@mdi/svg/svg/folder-network-outline.svg?raw ***!
  \******************************************************************/
/***/ ((module) => {

module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"mdi-folder-network-outline\" viewBox=\"0 0 24 24\"><path d=\"M15 20C15 19.45 14.55 19 14 19H13V17H19C20.11 17 21 16.11 21 15V7C21 5.9 20.11 5 19 5H13L11 3H5C3.9 3 3 3.9 3 5V15C3 16.11 3.9 17 5 17H11V19H10C9.45 19 9 19.45 9 20H2V22H9C9 22.55 9.45 23 10 23H14C14.55 23 15 22.55 15 22H22V20H15M5 15V7H19V15H5Z\" /></svg>";
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-BC-7VPxC_mjs":"2fcef36253529e5f48bc","node_modules_nextcloud_dialogs_dist_chunks_PublicAuthPrompt-ecDAsnUN_mjs":"d90f915546feffda97c2","apps_files_external_src_views_CredentialsDialog_vue":"96885e946aa91b196907","node_modules_nextcloud_dialogs_dist_chunks_FilePicker-CsU6FfAP_mjs":"0d588b9b111349c79c3c","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-cc29b1":"9fa10a9863e5b78deec8"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files_external-init.js.map?v=99df7ffe53eae5e08873