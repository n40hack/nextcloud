...
/* harmony import */ var vue_material_design_icons_ArrowRight_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! vue-material-design-icons/ArrowRight.vue */ "./node_modules/vue-material-design-icons/ArrowRight.vue");
/* harmony import */ var _services_ConfigService__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/ConfigService */ "./apps/files_sharing/src/services/ConfigService.ts");
/* harmony import */ var _NewFileRequestDialog_NewFileRequestDialogDatePassword_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./NewFileRequestDialog/NewFileRequestDialogDatePassword.vue */ "./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogDatePassword.vue");
/* harmony import */ var _NewFileRequestDialog_NewFileRequestDialogFinish_vue__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./NewFileRequestDialog/NewFileRequestDialogFinish.vue */ "./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogFinish.vue");
/* harmony import */ var _NewFileRequestDialog_NewFileRequestDialogIntro_vue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./NewFileRequestDialog/NewFileRequestDialogIntro.vue */ "./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogIntro.vue");
/* harmony import */ var _services_logger__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../services/logger */ "./apps/files_sharing/src/services/logger.ts");
/* harmony import */ var _models_Share_ts__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../models/Share.ts */ "./apps/files_sharing/src/models/Share.ts");
...
const sharingConfig = new _services_ConfigService__WEBPACK_IMPORTED_MODULE_14__["default"]();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  name: 'NewFileRequestDialog',
  components: {
    FileRequestDatePassword: _NewFileRequestDialog_NewFileRequestDialogDatePassword_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    FileRequestFinish: _NewFileRequestDialog_NewFileRequestDialogFinish_vue__WEBPACK_IMPORTED_MODULE_16__["default"],
    FileRequestIntro: _NewFileRequestDialog_NewFileRequestDialogIntro_vue__WEBPACK_IMPORTED_MODULE_17__["default"],
    IconCheck: vue_material_design_icons_Check_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
    IconNext: vue_material_design_icons_ArrowRight_vue__WEBPACK_IMPORTED_MODULE_13__["default"],
  ...
  setup() {
    return {
      STEP,
      n: _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.n,
  ...
  computed: {
    finishButtonLabel() {
      if (this.emails.length === 0) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'Close');
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.n)('files_sharing', 'Send email and close', 'Send {count} emails and close', this.emails.length, {
  ...
  methods: {
    onPageNext() {
      ...
      if (this.destination === '/' || this.destination === '') {
        ...
        destinationInput?.setCustomValidity((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'Please select a folder, you cannot share the root directory.'));
        form.reportValidity();
        return;
      }
    ...
    async onFinish() {
      if (this.emails.length === 0 || this.isShareByMailEnabled === false) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'File request created'));
        this.$emit('close');
        return;
      }
      if (sharingConfig.isMailShareAllowed && this.emails.length > 0) {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.n)('files_sharing', 'File request created and email sent', 'File request created and {count} emails sent', this.emails.length, {
          count: this.emails.length
        }));
      } else {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'File request created'));
    ...
    async createShare() {
      ...
      const shareUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateOcsUrl)('apps/files_sharing/api/v1/shares');
      try {
        const request = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].post(shareUrl, {
          // Always create a file request, but without mail share
          // permissions, only a share link will be created.
          shareType: sharingConfig.isMailShareAllowed ? _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_4__.ShareType.Email : _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_4__.ShareType.Link,
        ...
        const share = new _models_Share_ts__WEBPACK_IMPORTED_MODULE_19__["default"](request.data.ocs.data);
        this.share = share;
        _services_logger__WEBPACK_IMPORTED_MODULE_18__["default"].info('New file request created', {
          share
        });
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.showError)(errorMessage ? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'Error creating the share: {errorMessage}', {
          errorMessage
        }) : (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'Error creating the share'));
        _services_logger__WEBPACK_IMPORTED_MODULE_18__["default"].error('Error while creating share', {
          error,
          errorMessage
        });
        throw error;
    ...
    async setShareEmails() {
      ...
      const shareUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateOcsUrl)('apps/files_sharing/api/v1/shares/{id}', {
        id: this.share.id
      });
      try {
        // Convert link share to email share
        const request = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].put(shareUrl, {
          attributes: JSON.stringify([{
            value: this.emails,
            key: 'emails',
            scope: 'shareWith'
    ...
    async sendEmails() {
      ...
      const shareUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateOcsUrl)('apps/files_sharing/api/v1/shares/{id}/send-email', {
        id: this.share.id
      });
      try {
        // Convert link share to email share
    ...
    onEmailSendError(error) {
      const errorMessage = error.response?.data?.ocs?.meta?.message;
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.showError)(errorMessage ? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'Error sending emails: {errorMessage}', {
        errorMessage
      }) : (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.t)('files_sharing', 'Error sending emails'));
      _services_logger__WEBPACK_IMPORTED_MODULE_18__["default"].error('Error while sending emails', {
        error,
        errorMessage
      });
    }
...
/* harmony import */ var vue_material_design_icons_Information_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! vue-material-design-icons/Information.vue */ "./node_modules/vue-material-design-icons/Information.vue");
/* harmony import */ var vue_material_design_icons_AutoFix_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! vue-material-design-icons/AutoFix.vue */ "./node_modules/vue-material-design-icons/AutoFix.vue");
/* harmony import */ var _services_ConfigService__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/ConfigService */ "./apps/files_sharing/src/services/ConfigService.ts");
/* harmony import */ var _utils_GeneratePassword__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../utils/GeneratePassword */ "./apps/files_sharing/src/utils/GeneratePassword.ts");
...
const sharingConfig = new _services_ConfigService__WEBPACK_IMPORTED_MODULE_9__["default"]();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  name: 'NewFileRequestDialogDatePassword',
  components: {
    IconInfo: vue_material_design_icons_Information_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    IconPasswordGen: vue_material_design_icons_AutoFix_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
  ...
  computed: {
    passwordAndExpirationSummary() {
      if (this.expirationDate && this.password) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'The request will expire on {date} at midnight and will be password protected.', {
          date: this.expirationDate.toLocaleDateString()
        });
      }
      if (this.expirationDate) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'The request will expire on {date} at midnight.', {
          date: this.expirationDate.toLocaleDateString()
        });
      }
      if (this.password) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'The request will be password protected.');
      }
      return '';
    },
  ...
  methods: {
    ...
    async generatePassword() {
      await (0,_utils_GeneratePassword__WEBPACK_IMPORTED_MODULE_10__["default"])().then(password => {
...
/* harmony import */ var vue_material_design_icons_ClipboardText_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vue-material-design-icons/ClipboardText.vue */ "./node_modules/vue-material-design-icons/ClipboardText.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_1__.defineComponent)({
  ...
  components: {
    IconCheck: vue_material_design_icons_Check_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    IconClipboard: vue_material_design_icons_ClipboardText_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
  ...
  methods: {
    async copyShareLink(event) {
      ...
      if (!navigator.clipboard) {
        ...
        window.prompt((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Automatically copying failed, please copy the share link manually'), this.shareLink);
        return;
      }
      await navigator.clipboard.writeText(this.shareLink);
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Link copied'));
      this.isCopied = true;
      event.target?.select?.();
      setTimeout(() => {
        this.isCopied = false;
    ...
    addNewEmail(e) {
      ...
      if (e.target instanceof HTMLInputElement) {
        ...
        if (this.emails.includes(this.email.trim())) {
          e.target.setCustomValidity((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Email already added'));
          e.target.reportValidity();
          return;
        }
        // Check if the email is valid
        if (!this.isValidEmail(this.email.trim())) {
          e.target.setCustomValidity((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Invalid email address'));
          e.target.reportValidity();
          return;
        }
    ...
    onPasteEmails(e) {
      ...
      if (invalidEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.n)('files_sharing', 'The following email address is not valid: {emails}', 'The following email addresses are not valid: {emails}', invalidEmails.length, {
          emails: invalidEmails.join(', ')
        }));
      }
      // Warn about duplicate emails
      if (duplicateEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.n)('files_sharing', '{count} email address already added', '{count} email addresses already added', duplicateEmails.length, {
          count: duplicateEmails.length
        }));
      }
      if (validEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.n)('files_sharing', '{count} email address added', '{count} email addresses added', validEmails.length, {
...
/* harmony import */ var vue_material_design_icons_Lock_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue-material-design-icons/Lock.vue */ "./node_modules/vue-material-design-icons/Lock.vue");
/* harmony import */ var _nextcloud_vue_components_NcTextArea__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/vue/components/NcTextArea */ "./node_modules/@nextcloud/vue/dist/Components/NcTextArea.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  components: {
    ...
    IconInfo: vue_material_design_icons_InformationOutline_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    IconLock: vue_material_design_icons_Lock_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    NcTextArea: _nextcloud_vue_components_NcTextArea__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  methods: {
    onPickDestination() {
      const filepicker = (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.getFilePickerBuilder)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('files_sharing', 'Select a destination')).addMimeTypeFilter('httpd/unix-directory').allowDirectories(true).addButton({
        label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('files_sharing', 'Select'),
...
//# sourceMappingURL=apps_files_sharing_src_components_NewFileRequestDialog_vue-apps_files_sharing_src_components_NewFileRequestDialog_vue.js.map?v=3b81565d8f178e592d65