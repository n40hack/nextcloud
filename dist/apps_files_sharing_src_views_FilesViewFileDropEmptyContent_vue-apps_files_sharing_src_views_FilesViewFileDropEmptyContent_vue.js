...
/***/ "./node_modules/@mdi/svg/svg/cloud-upload-outline.svg?raw":
/*!****************************************************************!*\
  !*** ./node_modules/@mdi/svg/svg/cloud-upload-outline.svg?raw ***!
  \****************************************************************/
/***/ ((module) => {

module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"mdi-cloud-upload-outline\" viewBox=\"0 0 24 24\"><path d=\"M6.5 20Q4.22 20 2.61 18.43 1 16.85 1 14.58 1 12.63 2.17 11.1 3.35 9.57 5.25 9.15 5.88 6.85 7.75 5.43 9.63 4 12 4 14.93 4 16.96 6.04 19 8.07 19 11 20.73 11.2 21.86 12.5 23 13.78 23 15.5 23 17.38 21.69 18.69 20.38 20 18.5 20H13Q12.18 20 11.59 19.41 11 18.83 11 18V12.85L9.4 14.4L8 13L12 9L16 13L14.6 14.4L13 12.85V18H18.5Q19.55 18 20.27 17.27 21 16.55 21 15.5 21 14.45 20.27 13.73 19.55 13 18.5 13H17V11Q17 8.93 15.54 7.46 14.08 6 12 6 9.93 6 8.46 7.46 7 8.93 7 11H6.5Q5.05 11 4.03 12.03 3 13.05 3 14.5 3 15.95 4.03 17 5.05 18 6.5 18H9V20M12 13Z\" /></svg>";
...
/* harmony import */ var _nextcloud_upload__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nextcloud/upload */ "./node_modules/@nextcloud/upload/dist/index.mjs");
...
/* harmony import */ var _mdi_svg_svg_cloud_upload_outline_svg_raw__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @mdi/svg/svg/cloud-upload-outline.svg?raw */ "./node_modules/@mdi/svg/svg/cloud-upload-outline.svg?raw");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    const disclaimer = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'disclaimer', '');
    const shareLabel = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'label', '');
    const shareNote = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'note', '');
    const name = shareLabel || (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('files_sharing', 'File drop');
    const showDialog = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    const uploadDestination = (0,_nextcloud_upload__WEBPACK_IMPORTED_MODULE_3__.getUploader)().destination;
    (0,_nextcloud_upload__WEBPACK_IMPORTED_MODULE_3__.getUploader)().addNotifier(upload => {
      if (upload.status === _nextcloud_upload__WEBPACK_IMPORTED_MODULE_3__.UploadStatus.FINISHED && upload.file.name) {
    ...
    return {
      ...
      svgCloudUpload: _mdi_svg_svg_cloud_upload_outline_svg_raw__WEBPACK_IMPORTED_MODULE_9__
    };
  }
}));
...
.file-drop-empty-content[data-v-1988e27d] {
  /* TODO fix in library */
}
...
//# sourceMappingURL=apps_files_sharing_src_views_FilesViewFileDropEmptyContent_vue-apps_files_sharing_src_views_FilesViewFileDropEmptyContent_vue.js.map?v=6a1507033cb434cf8579