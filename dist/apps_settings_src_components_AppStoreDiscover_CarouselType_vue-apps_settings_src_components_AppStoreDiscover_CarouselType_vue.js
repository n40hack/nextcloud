...
/* harmony import */ var _PostType_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./PostType.vue */ "./apps/settings/src/components/AppStoreDiscover/PostType.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_2__.defineComponent)({
  ...
  components: {
    ...
    PostType: _PostType_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  props: {
  ...
  setup(props) {
    ...
    const currentIndex = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)(Math.min(1, props.content.length - 1));
    const shownElement = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)(props.content[currentIndex.value]);
    const hasNext = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => currentIndex.value < props.content.length - 1);
    const hasPrevious = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => currentIndex.value > 0);
    const internalId = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => props.id ?? (Math.random() + 1).toString(36).substring(7));
    const headingId = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => `${internalId.value}-h`);
    const transitionName = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)('slide-in');
    (0,vue__WEBPACK_IMPORTED_MODULE_2__.watch)(() => currentIndex.value, (o, n) => {
      if (o < n) {
    ...
    return {
      ...
      mdiCircleOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiCircleOutline,
      mdiCircleSlice8: _mdi_js__WEBPACK_IMPORTED_MODULE_0__.mdiCircleSlice8
    };
  }
}));
...
//# sourceMappingURL=apps_settings_src_components_AppStoreDiscover_CarouselType_vue-apps_settings_src_components_AppStoreDiscover_CarouselType_vue.js.map?v=9890a52a963d3c8bb5e4