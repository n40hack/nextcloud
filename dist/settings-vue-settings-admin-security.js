...
/* harmony import */ var _components_AdminTwoFactor_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/AdminTwoFactor.vue */ "./apps/settings/src/components/AdminTwoFactor.vue");
/* harmony import */ var _components_Encryption_EncryptionSettings_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Encryption/EncryptionSettings.vue */ "./apps/settings/src/components/Encryption/EncryptionSettings.vue");
/* harmony import */ var _store_admin_security_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./store/admin-security.js */ "./apps/settings/src/store/admin-security.js");
/**
...
_store_admin_security_js__WEBPACK_IMPORTED_MODULE_5__["default"].replaceState((0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'mandatory2FAState'));
const View = vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend(_components_AdminTwoFactor_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
new View({
  store: _store_admin_security_js__WEBPACK_IMPORTED_MODULE_5__["default"]
}).$mount('#two-factor-auth-settings');
const EncryptionView = vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend(_components_Encryption_EncryptionSettings_vue__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
/* harmony import */ var _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sharedTexts.ts */ "./apps/settings/src/components/Encryption/sharedTexts.ts");
...
/* harmony import */ var _EncryptionWarningDialog_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./EncryptionWarningDialog.vue */ "./apps/settings/src/components/Encryption/EncryptionWarningDialog.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    const allEncryptionModules = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'encryption-modules');
    ...
    const encryptionReady = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'encryption-ready');
    /** Are external backends enabled (legacy ownCloud stuff) */
    const externalBackendsEnabled = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'external-backends-enabled');
    /** URL to the admin docs */
    const encryptionAdminDoc = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'encryption-admin-doc');
    /** Is the encryption enabled */
    const encryptionEnabled = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)((0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'encryption-enabled'));
    ...
    function displayWarning(enabled) {
      ...
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.spawnDialog)(_EncryptionWarningDialog_vue__WEBPACK_IMPORTED_MODULE_12__["default"], {}, async confirmed => {
        try {
          if (confirmed) {
    ...
    async function update(key, value) {
      ...
      try {
        const {
          data
        } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].post(url, {
          value
        });
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.t)('settings', 'Unable to update server side encryption config'));
        _logger_ts__WEBPACK_IMPORTED_MODULE_8__["default"].error('Unable to update server side encryption config', {
          error
        });
        return false;
      }
    ...
    return {
      ...
      textExistingFilesNotEncrypted: _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_6__.textExistingFilesNotEncrypted,
...
/* harmony import */ var _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sharedTexts.ts */ "./apps/settings/src/components/Encryption/sharedTexts.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props, _ref) {
    ...
    return {
      ...
      textExistingFilesNotEncrypted: _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_2__.textExistingFilesNotEncrypted,
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-security.js.map?v=7ef46b9912801965aee1